...
plt.title("Frequency Histogram for Price (in USD) of Real Estate in the United States")
...
prices.hist(bins=BINS,
            ...
            color="orange")
plt.title("Relative frequency Histogram for Price (in USD) of Real Estate in the United States")
plt.xlabel("Price (in USD)")
